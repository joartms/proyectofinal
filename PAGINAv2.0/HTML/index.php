...
<body>
    ...
    <dialog id="popup">
        ...
        <h2 class="titulo-popup">Iniciar Sesión</h2>
            ...
            <form id="formulario-login" class="contenedor-inicio-sesion" action="../PHP/login.php" method="post">
            <div class="contenedor-inputs">
                ...
                <div class="img-input">
                    ...
                    <input id="username" type="text" name="username" class="inputs" placeholder="Ingrese el nombre de su usuario..." required>
                </div>
            </div>
            ...
            <div class="contenedor-inputs">
                ...
                <div class="img-input">
                    ...
                    <input id="password" type="password" name="password" class="inputs" placeholder="Introduzca su contraseña..." required>
                </div>
            </div>
    ...
    <script src="../JS/popup.js?v=5"></script>
    <?php endif; ?>
