...
/* CONFIGURACIÓN */
/*===============*/
const productosVisibles = 4; /* como la variable lo indica, se verán 3 productos*/
const anchoProducto = 250; /* representa el width: 250px de producto en css*/
const gap = 20; /* representa el gap: 60px de producto en css*/
...
/*===============================*/
const maximoDesplazamiento = 16; /* el maximodesplazamiento será a los productos.length (6) menos la cantidad que se va a ver, o sea 3 (6-3=3) 3 = maximodesplazamiento*/
